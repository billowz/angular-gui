...
angular.module('ngui.workbench', [
    ...
    'ngui.service', 'ngui.process', 'ncy-angular-breadcrumb'
  ])
    ...
    function($window, $timeout, $templateCache,
      ...
      return {
        ...
        controller: ['$scope', '$window', function($scope, $window) {
          ...
          menuService.listen(function(menu) {
            $scope.menu = menu;
          });
          ...
          $scope.supportThemes = themeConfig.getThemes(workbenchConfig.themeType);
        }],
        link: function($scope, $element, $attr, ctrl, $transclude) {
          ...
          function applyTheme(theme) {
            ...
            toggleSkin($scope.cfg ? $scope.cfg.skin : null);
          }

          function toggleSkin(val) {
            val = val || $scope.currentTheme.defaultSkin;
            var skin = ctrl.getSkin(val);
            if (!skin) {
              val = $scope.currentTheme.defaultSkin;
              skin = ctrl.getSkin(val);
            }
            if (!skin || skin === $scope.currentSkin) {
              return;
            }
